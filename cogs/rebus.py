...
class RebusCog(commands.Cog):
    HELP_META = {
        "title": "Rebus Puzzles",
        "summary": "A persistent channel-wide picture-word puzzle game with hints, fuzzy answers, skip voting, and leaderboard solves.",
        "details": "Use /rebus or choose Rebus Puzzles from /games. Anyone can answer or reveal hints. The starter or a moderator can end/skip immediately; everyone else can vote to skip.",
    }

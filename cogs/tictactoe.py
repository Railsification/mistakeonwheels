...
class TTTSquare(discord.ui.Button):
    def __init__(self, r: int, c: int):
        # IMPORTANT: label must be NON-empty.
        # Space " " fails Discord validation.
        super().__init__(
            label=EMPTY,
...
class TicTacToeCog(commands.Cog):
    ...
    async def tictactoe(
        ...
        # Must be public. The first follow-up inherits the defer visibility.
